                ...
                <div class="cs_footer_col">
                    <div class="cs_footer_item">
                        <div class="cs_text_widget">
                            <img src="{{ asset('img/logo-smn-v4.png') }}" alt="Logo"id="logo-footer">

                            <p class="cs_medium">La Société Marocaine de Neurologie</p>
                        </div>
                                ...
                                <i class="cs_accent_bg">
                                    <svg width="9" height="12" viewBox="0 0 9 12" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#307BC4" stroke-width="0.5" stroke-miterlimit="10"
                ...
                <div class="cs_footer_col">
                    <div class="cs_footer_item">
                        <ul class="cs_menu_widget cs_mp0">
                            ...
                            <li><a href="/congrès-internationaux">Agenda</a></li>
                    ...
                    <div class="cs_footer_item">
                        <ul class="cs_menu_widget cs_mp0">
                            ...
                            {{-- @if(!auth()->user() || !auth()->user()->inscription)
                                <li><a href="{{ route('inscription.index') }}">Inscription CNN 2024</a></li>
                            @endif --}}
