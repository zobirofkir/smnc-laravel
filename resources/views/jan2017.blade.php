<x-layouts.app>
    ...
    <div class="container">
        ...
        <h1 class="cs_fs_72 mb-0">Journées d'Automne de Neurologie 2017</h1>
        <div class="cs_height_54"></div>
        <div class="cs_blog_details_info">
        </div>
        <div class="cs_height_55"></div>
        <img src="{{ asset('img/blog/jan 2017.jpg') }}" alt="Blog Details" class="w-60 cs_radius_20">
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">4 - Vendredi 10 Novembre 2017 (Après-midi)</span>
                                    <br>
