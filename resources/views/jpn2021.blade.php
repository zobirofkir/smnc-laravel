<x-layouts.app>
    ...
    <div class="container">
        ...
        <h1 class="cs_fs_72 mb-0">Journées de Printemps de Neurologie 2021</h1>
        <div class="cs_height_54"></div>
        <div class="cs_blog_details_info">
        </div>
        <div class="cs_height_55"></div>
        <img src="{{ asset('img/blog/jpn2021.jpg') }}" alt="Blog Details" class="w-60 cs_radius_20">
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p> <span class="rediffusion-color">1 - Jeudi 03 Juin 2021</span> <br>
                                    Examen d'un patient comateux. ”</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/9fHrmHbFkNs?si=FCqY3KpsYYEfS6-Q"
                            ...
                            <div class="cs_testimonial_meta">
                                ...
                                <div class="cs_testimonial_meta_right">
                                    <h3 class="cs_fs_24 cs_semibold m-0 text-uppercase">B. Rohaut </h3>
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">1 - Jeudi 03 Juin 2021</span>
                                    Les EME</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/0uOnGv813Oo?si=mm7redbOK-tBJlO5"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="cs_testimonial_meta">
                                <div class="cs_testimonial_avatar"><img src="{{ asset('img/AVATAR.jpg') }}"
                                        alt="Avatar"></div>
                                <div class="cs_testimonial_meta_right">
                                    <h3 class="cs_fs_24 cs_semibold m-0 text-uppercase">H. Outin</h3>
                                    <p class="cs_heading_color m-0">France</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/u2cpWILwZWA?si=brmcHVOr4B2oXYcj"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="cs_testimonial_meta">
                                <div class="cs_testimonial_avatar"><img src="{{ asset('img/AVATAR.jpg') }}"
                                        alt="Avatar"></div>
                                <div class="cs_testimonial_meta_right">
                                    <h3 class="cs_fs_24 cs_semibold m-0 text-uppercase">Y. Benmouh, A. Satte </h3>
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">1 - Jeudi 03 Juin 2021</span> <br>
                                    AIC sylviens malins et craniectomie ”</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/Jukc837j0Qc?si=mzzmDg81HIgZKWKS"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">1 - Jeudi 03 Juin 2021</span> <br>
                                    ...
                                    Les occlusions du tronc basilaire</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/opppLExwpys?si=gyebGtYS3Pn0Z97v"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/aOJFLkv_SGY?si=Z510T6PXosBEeLUi"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">2 - Vendredi 04 Juin 2021</span> <br>
                                    Faiblesse musculaire en réanimation</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/9K1ukuTJyCw?si=tkIbRMAo8moobD1x"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">2 - Vendredi 04 Juin 2021</span> <br>
                                    Détresse respiratoire d'origine neurologique</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/za7g_DXeufU?si=TTY0nW96oxuvvdjQ"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/3RDo-43bjW0?si=4w8eCnOqlddo1Nnb"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="cs_testimonial_meta">
                                <div class="cs_testimonial_avatar"><img src="{{ asset('img/AVATAR.jpg') }}"
                                        alt="Avatar"></div>
                                <div class="cs_testimonial_meta_right">
                                    <h3 class="cs_fs_24 cs_semibold m-0 text-uppercase">I. Mouhi, N. Nirouk </h3>
                                    <p class="cs_heading_color m-0">Maroc</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">2 - Vendredi 04 Juin 2021</span> <br>
                                    Evaluation du pronostic neurologique du coma</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/vl7X3NqJMMI?si=-WT1ubxJL55hfiV0"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">2 - Vendredi 04 Juin 2021</span> <br>
                                    Aspects éthiques et prise de décision</p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/vGRhDX-fMEI?si=RoNMj5n3mbKvBC4c"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="cs_testimonial_meta">
                                <div class="cs_testimonial_avatar"><img src="{{ asset('img/AVATAR.jpg') }}"
                                        alt="Avatar"></div>
                                <div class="cs_testimonial_meta_right">
                                    <h3 class="cs_fs_24 cs_semibold m-0 text-uppercase">H. Benyaich</h3>
                                    <p class="cs_heading_color m-0">Maroc</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cs_slide">
                        <div class="cs_testimonial cs_style_2">
                            <div class="cs_testimonial_text cs_radius_25 cs_white_bg cs_fs_24">
                                ...
                                <p><span class="rediffusion-color">2 - Session 2 : Quoi de neuf en neurologie en 2021
                                        ?</span> <br>
                                    Cas clinique: </p>
                                <div class="rediffusion" style="color: aqua;">
                                    <a style="color: #307BC4;"
                                        href="https://www.youtube.com/embed/EN2I2TbMbdo?si=eCgU8Pk8ax5ca94"
                                        class="cs_video_open cs_white_color cs_text_btn_2 cs_fs_20">
                                        <span class="cs_text_btn_icon">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
