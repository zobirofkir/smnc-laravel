...
return array(
    ...
    */
    ...
    'attributes' => array(
        ...
        'last_name' => 'Nom',
        'city' => 'Ville',
        'phone_number' => 'Téléphone GSM',
        'activity-area' => 'Secteur activité ',
        'status' => 'Statut',
        'business_address' => 'Adresse professionnelle',
        'business_phone_number' => 'Téléphone professionnel',
        'password' => 'Mot de pass',
        'abstract_type' => "Type d'abstract",
        'authors.*.last_name' => 'Nom'
    ),
